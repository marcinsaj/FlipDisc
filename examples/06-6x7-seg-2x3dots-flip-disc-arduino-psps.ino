/*----------------------------------------------------------------------------------*
 * A simple example of controlling 6 x 7-segment and 2 x 3x1-dot displays           *
...
void loop() 
{
  ...
  FlipDisc.ToDot(2, 1, 1);  /* Set first dot of the second dot display */
  delay(1000);
  FlipDisc.ToDot(1, 2, 1);  /* Set second dot */
  FlipDisc.ToDot(2, 2, 1);  /* Set second dot of the second dot display */
  delay(1000);
  FlipDisc.ToDot(1, 3, 1);  /* Set third dot */
  FlipDisc.ToDot(2, 3, 1);  /* Set third dot of the second dot display */
  delay(3000);
  ...
  delay(1000);
  FlipDisc.Dot(1, 0, 1, 1); /* Reset first dot, set second and third dot */
  delay(1000);
  FlipDisc.Dot(2, 1);       /* Set first dot of the second dot display */
  delay(1000);
  FlipDisc.Dot(2, 0, 1);    /* Reset first dot and set second dot */
  delay(1000);
  FlipDisc.Dot(2, 1, 1, 0); /* ReSet first and second dot, reset third */
  delay(3000);
  ...
  FlipDisc.ToDot(1, 1, 1);    /* Set dot no.1 of the first dot display */
  ...
  FlipDisc.ToDot(2, 1, 1);    /* Set dot no.1 of the second dot display */
  FlipDisc.ToDot(2, 2, 1);    /* Set dot no.2 */
  FlipDisc.ToDot(2, 3, 0);    /* Reset dot no.3 */
  ...
  FlipDisc.Seg(7, 1, 7, CLR, DEG, FAH);
  FlipDisc.Dot(1, 0, 0, 1);
  FlipDisc.Dot(2, 0, 0, 0);
  delay(3000);

  /* Display temperature: 23.5°C */
  FlipDisc.Seg(2, 3, 5, CLR, DEG, CEL);
  FlipDisc.Dot(1, 0, 0, 1);
  FlipDisc.Dot(2, 0, 0, 0);
  delay(3000);
